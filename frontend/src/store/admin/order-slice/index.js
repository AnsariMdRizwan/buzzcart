...
export const getAllOrdersForAdmin = createAsyncThunk('/order/getAllOrdersForAdmin', async () => {
    const response = await axios.get(`https://buzzcart-web.onrender.com/api/admin/orders/get`)
...
export const getOrderDetailsForAdmin = createAsyncThunk('/order/getOrderDetailsForAdmin', async (id) => {
    const response = await axios.get(`https://buzzcart-web.onrender.com/api/admin/orders/details/${id}`)

    return response.data;
})
export const updateOrderStatus = createAsyncThunk('/order/updateOrderStatus', async ({ id, orderStatus }) => {
    const response = await axios.put(`https://buzzcart-web.onrender.com/api/admin/orders/update/${id}`, { orderStatus })
